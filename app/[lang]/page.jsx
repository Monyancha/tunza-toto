            ...
            <div className="basis-full xl:basis-1/2 hidden xl:block relative w-[500px] ">
              <svg
                ...
                <defs>
                  ...
                  <radialGradient id="paint0_radial_4801_13605" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(805.322 373.168) rotate(134.675) scale(1098.13)">
                    <stop stop-color="#089faf" stop-opacity="0.6" />
                    <stop offset="1" stop-color="#089faf" stop-opacity="0" />
                  </radialGradient>
                </defs>
              </svg>
              <div className="bg-primary h-full w-full rounded-3xl rounded-tr-none  xl:p-[60px] ltr:xl:pr-9 rtl:xl:pl-9 relative  overflow-hidden">
                ...
                <div className="text-2xl lg:text-3xl xl:text-5xl font-semibold text-primary-foreground rtl:pr-12">
                  Cugi <span className="xl:block"></span>
                  Tunza Toto
                </div>
                ...
                <div className="text-xl  mt-2 text-primary-foreground flex gap-1">
                  ...
                  A comprehensive Maternal Health platform that is capable of delivering a comprehensive automated pre and post natal health journey that provides date and time appropriate messages based on a mother’s expected date of delivery and a baby’s date of birth.
                </div>
                      ...
                      <SwiperSlide>
                        <div className="ltr:pl-4 rtl:pr-8 pb-10">
                          ...
                          <div className="text-lg  text-default-800 mt-4">
                            Login to access all the features provided by Tunza Toto platform.
                          </div>
                        </div>
                      </SwiperSlide>
